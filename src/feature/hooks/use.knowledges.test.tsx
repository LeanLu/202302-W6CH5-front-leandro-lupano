...
// describe("Given the knowledge custom hook and the TestErrorIDUpdate", () => {
//   let mockPayloadWithoutId: Partial<KnowledgeStructure>;
//   let repo: KnowledgeApiRepo;

//   beforeEach(async () => {
//     repo = new KnowledgeApiRepo();

//     mockPayloadWithoutId = {
//       name: "Test-3",
//     };
...
//     const TestErrorIDUpdate = function () {
//       const { updateKnowledge } = useKnowledges(repo);

//       return (
//         <button onClick={() => updateKnowledge(mockPayloadWithoutId)}>
//           updateIDError
//         </button>
//       );
//     };
...
//       render(
//         <Provider store={store}>
//           <TestErrorIDUpdate></TestErrorIDUpdate>
//         </Provider>
//       )
//     );
//   });

//   describe("When the TestError component is rendered and the update button is clicked and the knowledge has not id", () => {
//     test("Then, the updateKnowledge function should be catch the error", async () => {
//       const element = await screen.findByRole("button");
//       await act(async () => userEvent.click(element));
//       await expect(repo.updateKnowledge).rejects.toThrow();
